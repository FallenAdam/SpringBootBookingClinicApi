...
VALUES ('Nguyễn Văn An'     , 'an.nguyen@example.com'      , '$2a$12$K0d6FTjJScIgNEGXUfAYUu77aEifBbifcGzOqvZxeWK1C0IomvLTO'  , 'Hà Nội'    ,'0914453588'  , 'anh_dai_dien.jpg ' ,  'MALE'  ,        NULL        ,              NULL         ,          NULL        ,         NULL        ,  'No Comment' ,     1   ,     1    ,'2023-10-10' , '2023-12-25'  ,'2023-12-30'),
       ('Lê Thị Hồng'       , 'hong.le@example.com'       , '$2a$12$K0d6FTjJScIgNEGXUfAYUu77aEifBbifcGzOqvZxeWK1C0IomvLTO'  , 'Hà Giang'  ,'0948157159'  , 'anh_dai_dien.jpg ' , 'FEMALE' ,'Bác Sĩ Chuyên Khoa','Chứng chỉ cấp cứu đột quỵ',        'Tiến Sĩ'     ,        'Da Liễu'    ,  'No Comment' ,     2   ,     1     ,'2023-08-30' , '2023-10-05'  ,'2023-12-25'),
       ('Phạm Minh Khoa'    , 'khoa.pham@example.com'      , '$2a$12$K0d6FTjJScIgNEGXUfAYUu77aEifBbifcGzOqvZxeWK1C0IomvLTO'  , 'Cao Bằng'  , '0912300247' , 'anh_dai_dien.jpg ' ,  'MALE'  ,'Bác Sĩ Chuyên Khoa',  'Chuyên khoa Da liễu'    ,'P.Giáo Sư, Tiến Sĩ'  ,      'Thần Kinh'    ,  'No Comment' ,     2   ,     1     ,'2023-09-20' , '2023-11-02'  ,'2023-11-30'),
       ('Trần Thị Mai'      , 'mai.tran@example.com'       , '$2a$12$K0d6FTjJScIgNEGXUfAYUu77aEifBbifcGzOqvZxeWK1C0IomvLTO'  , 'Bắc Kạn'   ,'0915133607'  , 'anh_dai_dien.jpg ' , 'FEMALE' ,        NULL        ,            NULL           ,          NULL        ,         NULL        ,  'No Comment' ,     3   ,     1     ,'2023-10-09' , '2023-12-08'  ,'2023-11-30'),
       ('Đỗ Văn Bình'       , 'binh.do@example.com'        , '$2a$12$K0d6FTjJScIgNEGXUfAYUu77aEifBbifcGzOqvZxeWK1C0IomvLTO'  , 'Điện Biên' ,'0913602103'  , 'anh_dai_dien.jpg ' ,  'MALE'  ,        NULL        ,            NULL           ,          NULL        ,         NULL        ,  'No Comment' ,     3   ,     1     ,'2023-12-10' , '2023-12-09'  ,'2023-12-30'),
       ('Vũ Quang Huy'      , 'huy.vu@example.com'         , '$2a$12$K0d6FTjJScIgNEGXUfAYUu77aEifBbifcGzOqvZxeWK1C0IomvLTO'  , 'Lào Cai'   ,'0905372666'  , 'anh_dai_dien.jpg ' ,  'MALE'  ,'Bác Sĩ Chuyên Khoa','Trường ĐH Y dược TP.HCM'  ,        'Thạc Sĩ'     , 'Vô Sinh-Hiếm Muộn' ,  'No Comment' ,     2   ,     1     ,'2023-11-12' , '2023-12-11'  ,'2023-12-30'),
       ('Nguyễn Văn Minh'   , 'minh.nguyen@example.com'    , '$2a$12$K0d6FTjJScIgNEGXUfAYUu77aEifBbifcGzOqvZxeWK1C0IomvLTO'  , 'Lai Châu'  ,'0911375199'  , 'anh_dai_dien.jpg ' ,  'MALE'  ,        NULL        ,            NULL           ,          NULL        ,          NULL       ,  'No Comment' ,     3   ,     1     ,'2023-10-13' , '2023-12-10'  ,'2023-12-25'),
       ('Phạm Ngọc Lan'     , 'lan.pham@example.com'       , '$2a$12$K0d6FTjJScIgNEGXUfAYUu77aEifBbifcGzOqvZxeWK1C0IomvLTO'  , 'Sơn La'    ,'0949522905'  , 'anh_dai_dien.jpg ' , 'FEMALE' ,        NULL        ,            NULL           ,          NULL        ,          NULL       ,  'No Comment' ,     3   ,     1     ,'2023-08-17' , '2023-10-18'  ,'2023-11-30'),
       ('Lê Thị Thu Cúc'    , 'thucuc.le@example.com'      , '$2a$12$K0d6FTjJScIgNEGXUfAYUu77aEifBbifcGzOqvZxeWK1C0IomvLTO'  , 'Yên Bái'   ,'0949234388'  , 'anh_dai_dien.jpg ' , 'FEMALE' ,        NULL        ,            NULL           ,          NULL        ,          NULL       ,  'No Comment' ,     3   ,     1     ,'2023-09-20' , '2023-10-19'  ,'2023-12-30'),
       ('Trần Thị Như Ý'    , 'nhuy.tran@example.com'      , '$2a$12$K0d6FTjJScIgNEGXUfAYUu77aEifBbifcGzOqvZxeWK1C0IomvLTO'  , 'Hòa Bình'  ,'0914500150'  , 'anh_dai_dien.jpg ' , 'FEMALE' ,'Bác Sĩ Chuyên Khoa','Đại học Y dược TP. HCM'   ,'Chuyên Viên Cao Cấp' ,   'Tai-Mũi-Họng'    ,  'No Comment' ,     2   ,     1     ,'2023-08-25' , '2023-09-20'  ,'2023-10-15');
